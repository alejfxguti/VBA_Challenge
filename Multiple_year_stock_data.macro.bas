...
'Loop through all the sheets.
    ...
    'Setup before loops
        ...
        'Note: Yearly Change is: (Close Price at the end of a trading year - Open Price at the beginning of the trading year)
    ...
    'Create final table for greatest stock price increase and decrease and greatest total volume
    'First label the cells according to the sample image provided in the challenge assignment
